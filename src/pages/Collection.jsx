...
const Collection = () => {
  ...
  const [filterBroduct, setFilterBroduct] = useState([])
  ...
  const applyFilter = () => {
    ...
    setFilterBroduct(productCopy);
  }

  const sortProducts = () => {
    let fpCopy = filterBroduct.slice();
    switch(sortType) {
      case 'low-high':
        setFilterBroduct(fpCopy.sort((a, b) => a.price - b.price));
        break;
      case 'high-low':
        setFilterBroduct(fpCopy.sort((a, b) => b.price - a.price));
        break;
      default:
        applyFilter();
        break;
